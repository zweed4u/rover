...
class IMUTest:
    ...
    def test_turn_left(self, degrees):
        degrees /= 1.0299227 # scale factor got from manual calibration
        #r_degree /= .99299227 # scale factor got from manual calibration
    ...
    def calibrate_get_scale_factor_no_bias(self):
        ...
        plt.axis([stay_time[0], left_time[0]+18, -125, 125])
        plt.show()
