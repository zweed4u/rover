...
class Maze:
    def __init__(self, calibration_duration_seconds):
        ...
        self.left_right_threshold_cm = 15.0  # 60cm wide rover ~20cm wide, ~40cm each side, divide by 2 and wiggle room, literally
    ...
    def go(self):
        ...
        # TODO:wiggle
        if self.sensors.read_sensor_a() < self.left_right_threshold_cm:
            # speed up right side
            pass
        elif self.sensors.read_sensor_c() < self.left_right_threshold_cm:
            # speed up left side
            pass
        # return to normal pwm here
