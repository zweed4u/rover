...
set rc [catch {
  ...
  set_property webtalk.parent_dir S:/4-19-21/project/newfolder_sys.cache/wt [current_project]
  set_property parent.project_path S:/4-19-21/project/newfolder_sys.xpr [current_project]
  set_property ip_repo_paths S:/4-19-21/ip [current_project]
  set_property ip_output_repo S:/4-19-21/project/newfolder_sys.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  add_files -quiet S:/4-19-21/project/newfolder_sys.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files S:/4-19-21/src/design_1.bd
  set_property is_locked true [get_files S:/4-19-21/src/design_1.bd]
  set_param project.isImplRun false
  read_edif s:/4-19-21/src/ip/design_1_imu_wrapper_0_0/imu.edn
  read_xdc S:/4-19-21/src/constraints.xdc
  set_param project.isImplRun true
