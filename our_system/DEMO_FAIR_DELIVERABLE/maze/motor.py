...
class Motor:
    ...
    def get_encoder_a(self):
        self.c_motor.read_encoder_a.restype = c_uint32
        return self.c_motor.read_encoder_a()

    def clear_encoder_b(self):
        self.c_motor.clear_motor_encoder_b()

    def get_encoder_b(self):
        self.c_motor.read_encoder_b.restype = c_uint32
        return self.c_motor.read_encoder_b()

    def clear_encoder_c(self):
        self.c_motor.clear_motor_encoder_c()

    def get_encoder_c(self):
        self.c_motor.read_encoder_c.restype = c_uint32
        return self.c_motor.read_encoder_c()

    def clear_encoder_d(self):
        self.c_motor.clear_motor_encoder_d()

    def get_encoder_d(self):
        self.c_motor.read_encoder_d.restype = c_uint32
        return self.c_motor.read_encoder_d()
